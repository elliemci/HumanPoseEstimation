...
function App() {
  ...
  */}
      ...
      <Grid container spacing={3}>
        <Grid item xs={12}>
        {/* AppBar displays info and action relating to the current screen */}
      ...
      <Grid containe spacing={3}>
        <Grid item xs={12}>
          {/* Cards are surfaces that display content and action on a single topic */}
          <Card >
            <CardContent>
              <Webcam 
                ref={webcamRef} //ref stores the state so that updating the state doesn’t cause the component to re-render.
                style={{
                  marginTop: "10px",
                  marginBottom: "10px",
                  marginLeft: "auto",
           ...
           <CardActions style={{ justifyContent:'center' }}>
              <Grid container spacing={0}>
                <Grid item xs={12}>
                  <Toolbar style={{ justufyContent: 'center' }}>
                    <Card cassName={classes.statsCard}>
                      <CardContent>
